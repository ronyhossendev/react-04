    ...
    <section>
      <Container>
        ...
        <div className="flex justify-between">
            ...
            <p className="text-[#524D43] text-[20px] pt-4 w-[325px] h-[118px] font-normal font-paprika">Aromatherapy is just another thing to look and feel younger, more energetic and attractive in your body.
</p>
                <div> <h3 className="text-black text-7 font-bold font-openSans pt-10">HIGHLIGHTS</h3>
                <p className="text-[#524D43] text-[20.
                px] font-normal font-paprika w-[325px] h-[128px] pt-4">Aroma therapy is just another thing to look and feel younger, more energetic and attractive in your body.</p>
</div>
            </div>
            ...
            <p className="text-[#524D43] font-normal font-paprika w-[325px] h-[128px] text-[18px] pt-4 ">The Namaste Massage is a deep, fluid, rhythmic massage that use different part of the body at the same time.</p>
                <div>
                  <h3 className="text-[#363024] text[28px] font-bold font-openSans pt-[32px]" >HAIR COLOURING</h3>
                  <p className="text-[#524D43] font-normal font-paprika text-[18px] w-[325px] h-[128px] pt-4 " >A wide array of facial modalities ranging from European to Thai and Japanese techniques that work.</p>
                </div>
            </div>
